...
Original file is located at
    https://colab.research.google.com/drive/1oQRUPuuz-tfkwtWqfOBJUBFx28SDP6vl
"""
...
# Using TSNE for Dimentionality reduction for 15 Features(Generated after cleaning the data) to 3D
